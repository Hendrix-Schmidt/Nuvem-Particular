...
public class AlertBox {
    ...
    public static void display(String title, String message) {
        ...
        //painelPrincipal.getStyleClass().add("borda");
        painelPrincipal.minHeight(initX);
        painelPrincipal.minWidth(initY);

        VBox layoutV = new VBox(10);
        layoutV.setMinWidth(200);
        layoutV.setMinHeight(50);
        //layoutV.getStyleClass().add("borda2");
        layoutV.getChildren().add(label);
        layoutV.setAlignment(Pos.TOP_CENTER);

        HBox layoutH = new HBox(10);
        layoutH.setMinWidth(200);
        layoutH.setMinHeight(40);
        //layoutH.getStyleClass().add("borda3");
        layoutH.getChildren().add(closeButton);
        layoutH.setAlignment(Pos.TOP_CENTER);
        ...
        painelPrincipal.getChildren().addAll(layoutV, stackH);
    ...
    public static boolean displayOption(String title, String message) {
       ...
       // closeButton.setOnAction(e -> window.close());
        ...
        HBox layoutH = new HBox(10);
        layoutH.getChildren().addAll(yesButton, noButton);
